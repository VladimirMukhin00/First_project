...
<html lang="ru">
  ...
  <body>
    ...
    $cat = selectOne('categories', ['id' => $_GET['id']]);
    $names_users = selectAllFromPostsWithUsers('posts', 'users');
    $names = [];
    foreach ($names_users as $nam){
        if ($nam['id_category'] == $_GET['id'] && $nam['status'] == 1){
            $names[] = $nam['username'];
        }
    }
    $n = 0;
    ...
    <div class="container">
      <div class="content row">
        ...
        <div class="main-content col-md-9 col-12">
          <h2><?="Статьи раздела " ?> <strong class="ccc"> <?= $cat['name'] ?></strong></h2>
